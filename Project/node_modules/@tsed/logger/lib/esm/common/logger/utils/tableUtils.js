 ...
 * @returns {string}
 */
export function buildStartLine(fields, settings) {
    let line = "┌";
 ...
 * @returns {string}
 */
export function buildEndLine(fields, settings) {
    let line = "└";
    let list = Object.keys(fields);
    list.forEach((key, index) => {
        if (index !== 0 && index !== list.length) {
 ...
 * @returns {string}
 */
export function buildLine(fields, settings, char = "─") {
    let line = "";
 ...
 *
 */
export function buildLineData(scope, fields, settings) {
    let line = "";
    Object.keys(fields).forEach((key) => {
        line += "│ ";
        line += scope[key];
 ...
 * @returns {string}
 */
export function drawTable(list, settings = {}) {
