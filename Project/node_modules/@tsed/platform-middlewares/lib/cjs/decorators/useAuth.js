    ...
    return (...args) => {
        switch ((0, core_1.decoratorTypeOf)(args)) {
            case core_1.DecoratorTypes.METHOD:
                return (0, core_1.useDecorators)((0, core_1.StoreFn)((store) => {
                    if (!store.has(guardAuth)) {
                        return (0, useBefore_1.UseBefore)(guardAuth);
                    }
                }), (0, authOptions_1.AuthOptions)(guardAuth, options))(...args);
            case core_1.DecoratorTypes.CLASS:
                (0, core_1.decorateMethodsOf)(args[0], UseAuth(guardAuth, options));
                break;
            default:
