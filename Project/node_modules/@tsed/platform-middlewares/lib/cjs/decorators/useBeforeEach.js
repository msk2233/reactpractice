...
function UseBeforeEach(...args) {
    return (...decoratorArgs) => {
        switch ((0, core_1.decoratorTypeOf)(decoratorArgs)) {
            case core_1.DecoratorTypes.METHOD:
                return (0, useBefore_1.UseBefore)(...args)(...decoratorArgs);
            case core_1.DecoratorTypes.CLASS:
                (0, core_1.decorateMethodsOf)(decoratorArgs[0], (0, useBefore_1.UseBefore)(...args));
                break;
            default:
