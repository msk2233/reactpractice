...
export declare function Request(options: ParamOptions<any>): ParameterDecorator;
...
export declare function Req(options: Partial<ParamOptions>): ParameterDecorator;
