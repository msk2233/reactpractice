...
const PassportMessage_1 = require("../errors/PassportMessage");
/**
 * @ignore
 */
let ProtocolsService = class ProtocolsService {
    ...
    injector;
    getProtocols() {
        return this.injector.getProviders(constants_1.PROVIDER_TYPE_PROTOCOL);
    }
    getProtocolsNames() {
    ...
    async call(method, protocols, options, ctx) {
        ...
        try {
            ...
            // @ts-ignore
            const fn = (0, util_1.promisify)(passport_1.default[method](protocols.length === 1 ? protocols[0] : protocols, options));
            await fn(request, response);
        }
        catch (er) {
            if (!(0, core_1.ancestorsOf)(er).includes(Error)) {
        ...
        return async (req, ...args) => {
            ...
            if (req.$ctx) {
                ...
                try {
                    ...
                    if (err instanceof PassportMessage_1.PassportMessage) {
...
tslib_1.__decorate([
    (0, di_1.Inject)(),
    tslib_1.__metadata("design:type", common_1.PlatformHandler)
