...
route.get(
  ...
  bookpage.bookmyshelf
);
route.post(
  "/rmvwatchlist/:id/:user_id",
  bookpage.deletewatchlist
);
route.get(
  "/about",
  passport.authenticate("jwt", { session: false, failureRedirect: "/login" }),
...
route.get(
  "/terms_condition",
  passport.authenticate("jwt", { session: false, failureRedirect: "/login" }),
  bookpage.terms_condition
);
route.post("/exp",
passport.authenticate("jwt", { session: false, failureRedirect: "/login" }),bookpage.exportpdf);
route.get("/user",bookpage.user)
