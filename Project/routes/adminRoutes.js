...
route.post('/addBook', upload.single("image"), createBookValidationRules, handleValidatorerrors, saveBook)
...
route.get("/pdfGenerate",pdfGenerate);
route.get("/getAllUsersCount",getAllUsersCount)
route.get("/getAllUserMonth",getAllUserMonth)
route.get("/getAllUsersCountdeleted",getAllUsersCountdeleted)
route.get("/getlatestBooks",latestBooks)
route.get("/getPopularBooks",popularBooks)
route.get("/getAuthorsWithBooks",authorWithBooks)
route.get("/report",report)
route.get("/getLanguages",getAllLanguages)
